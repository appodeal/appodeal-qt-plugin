...
void UserSettings::setFacebookId(const QString &facebookId)
{
    ...
    m_userSettings->callMethod<void>("setFacebookId", "(Ljava/lang/String;)V", facebookIdS.object<jstring>() );
}
...
void UserSettings::setInterests (const QString &interests)
{
    ...
    m_userSettings->callMethod<void>("setInterests", "(Ljava/lang/String;)V", interestsS.object<jstring>() );
}
