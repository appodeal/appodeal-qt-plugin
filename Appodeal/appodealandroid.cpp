...
void AppodealAndroid::setInterests(const QString &interests){
    ...
    m_Activity->callMethod<void>("setInterests", "(Ljava/lang/String;)V", interestsS.object<jstring>());
}
...
void AppodealAndroid::setCustomRule(const QString &name, const double &value){
    ...
    m_Activity->callMethod<void>("setCustomRule", "(Ljava/lang/String;D)V", nameS.object<jstring>(), value);
}
void AppodealAndroid::setCustomRule(const QString &name, const int &value){
    QAndroidJniObject nameS = QAndroidJniObject::fromString(name);
    m_Activity->callMethod<void>("setCustomRule", "(Ljava/lang/String;I)V", nameS.object<jstring>(), value);
}
void AppodealAndroid::setCustomRule(const QString &name, const bool &value){
    QAndroidJniObject nameS = QAndroidJniObject::fromString(name);
    m_Activity->callMethod<void>("setCustomRule", "(Ljava/lang/String;Z)V", nameS.object<jstring>(), value);
}
void AppodealAndroid::setCustomRule(const QString &name, const QString &value){
    ...
    m_Activity->callMethod<void>("setCustomRule", "(Ljava/lang/String;Ljava/lang/String;)V", nameS.object<jstring>(), valueS.object<jstring>());
}
